...
func main() {
	...
	//childrenUrls := make(map[string][]string, 0)
	...
	// 	childrenUrls[currentUrl] = make([]string, 0)
	...
	// 			childrenUrls[currentUrl] = append(childrenUrls[currentUrl], sameDomainLinks[i].Href)
	// 		}
	// 	}
	// }
